...
while temp1 < total_rows:
    ...
    try:
        ...
        discount_details = discount_details.text
        ...
        with open("tazzfinaldata.csv", "a", encoding="utf-8") as csvfile:
            ...
            writer.writerow(['2gis.ua',rest_name,tags,rating.text,advertising,discount_details,rest_description.text,website,email_id,facebook_link,instagram_link,phone_number,final_address,dt_string,dt_string])
        print(temp1)
        temp1 = temp1 + 1
        ...
        try:
            ...
            with open("tazzfinaldata.csv", "a", encoding="utf-8") as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(
                    ['2gis.ua', rest_name, tags, rating.text, advertising, discount_details, rest_description.text, website,
                     email_id, facebook_link, instagram_link, phone_number, final_address, dt_string, dt_string])
            print(temp1)
            driver.close()
            temp1 = temp1 + 1
        except Exception as e:
            ...
            with open("tazzfinaldata.csv", "a", encoding="utf-8") as csvfile:
                writer = csv.writer(csvfile)
                writer.writerow(
                    ['2gis.ua', rest_name, tags, rating.text, advertising, discount_details, rest_description.text,
                     website,
                     email_id, facebook_link, instagram_link, phone_number, final_address, dt_string, dt_string])
            print(temp1)
            temp1 = temp1 + 1
